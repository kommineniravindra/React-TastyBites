...
const productsSlice = createSlice({
  ...
  initialState: {
    ...
    snacks: [
      ...
      { name: "French Fries", price: 160, image: '/images/French Fries.avif' },
      { name: "Masala Corn", price: 85, image: '/images/Masala Corn.avif' },
      { name: "Nachos", price: 99, image: '/images/Nachos.avif' },
      { name: "Pav Bhaji", price: 45, image: '/images/Pav Bhaji.jpg' },
      { name: "Spring Rolls", price: 75, image: '/images/Spring Rolls.avif' },
      { name: "Vada Pav", price: 65, image: '/images/Vada Pav.jpg' },
      { name: "Veg Manchurian", price: 120, image: '/images/Veg Manchurian.avif' },
      { name: "Cheese Balls", price: 80, image: '/images/Cheese Balls.jpg' },
      { name: "Chicken Popcorn", price: 120, image: '/images/Chicken Popcorn.avif' },
      { name: "Dhokla", price: 130, image: '/images/Dhokla.jpg' },
      { name: "French Fries", price: 160, image: '/images/French Fries.avif' },
